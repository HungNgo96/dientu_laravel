      ...
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
                          ...
                          <div class="col-md-6">
                            ...
                            <select class="form-control" v-model="sanpham.loaisanpham" required>
                              ...
                              <option
                                ...
                                v-if="loaisanpham.phanloai=='dt' || loaisanpham.phanloai == '' "
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            ...
                            <input
                              ...
                              v-model="cauhinhdienthoai.manhinh"
                              required
                            >
                          </div>
                          <div class="col-md-4">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            ...
                            <input
                              ...
                              class="form-control"
                              placeholder="Camera"
                              v-model="cauhinhdienthoai.camera"
                              required
                            >
                          </div>
                          <div class="col-md-4">
                            ...
                            <input
                              ...
                              class="form-control"
                              placeholder="Bộ nhớ"
                              v-model="cauhinhdienthoai.bonho"
                              required
                            >
                          </div>
                        </div>&nbsp;
                        <div class="row">
                          ...
                          <div class="col-md-8">
                            ...
                            <input
                              ...
                              v-model="cauhinhdienthoai.thongtinkhac"
                            >
                          </div>
                        </div>
                      </div>
            ...
            <!-- end-modal -->
            <div class="table-reponsive">
              <table id="tabledienthoai" class="table table-bordered table-hover display nowrap">
                <thead>
                  <tr>
                    <th>id</th>
                    <th>Loại sản phẩm</th>
                ...
                <tbody>
                  <tr v-for="(sanpham,index) in danhsachsanpham" :key="index">
                    ...
                    <td>
                      <img :src="'../../public/image/dienthoai/' + sanpham.hinhanh ">
                    </td>
                    ...
                    <td>
                      <button
                        ...
                        @click="editSanpham(sanpham,sanpham.cauhinhdienthoai,sanpham.mota)"
                      >
...
// var csrf = '{{csrf_token()}}';
$(() => {
  var table = $("#tabledienthoai").DataTable({
    lengthChange: true,
  ...
  table
    .buttons()
    .container()
    .appendTo("#tabledienthoai_wrapper .col-md-6:eq(0)");
});
...
export default {
  ...
  created() {
    ...
    // Fire.$on('AfterCreate',()=>{this.getDanhsachsanpham()
    // })
  },
  mounted() {},
  methods: {
    ...
    addSanpham() {
      ...
      this.sanpham.mota3 = "";
      //dienthoai
      this.cauhinhdienthoai.manhinh = "";
      this.cauhinhdienthoai.hdh = "";
      this.cauhinhdienthoai.cpu = "";
      this.cauhinhdienthoai.ram = "";
      this.cauhinhdienthoai.camera = "";
      this.cauhinhdienthoai.bonho = "";
      this.cauhinhdienthoai.pin = "";
      this.cauhinhdienthoai.thongtinkhac = "";
    },
    closecreate() {
      $("#addtable").modal("hide");
      $(".images").val("");
    ...
    getDanhsachsanpham2() {
      axios
        .get("sanphamdienthoai")
        .then(response => {
          // console.log(response.data);
          this.danhsachsanpham = response.data;
          //cauhínhanpham
          axios
            .get("cauhinhdienthoai")
            .then(response => {
              // console.log(response.data);
              this.danhsachcauhinhdienthoai = response.data;
            })
            .catch(error => {
    ...
    createSanpham() {
      ...
      axios
        .post("sanphamdienthoai", {
          ...
          //maytinh
          manhinh: this.cauhinhdienthoai.manhinh,
          hdh: this.cauhinhdienthoai.hdh,
          cpu: this.cauhinhdienthoai.cpu,
          ram: this.cauhinhdienthoai.ram,
          camera: this.cauhinhdienthoai.camera,
          bonho: this.cauhinhdienthoai.bonho,
          pin: this.cauhinhdienthoai.pin,
          thongtinkhac: this.cauhinhdienthoai.thongtinkhac
        })
        .then(response => {
    ...
    editSanpham(sanpham, dienthoai, mota) {
      $("#tableedit").modal("show");
      $(".images").val("");
      this.sanpham = sanpham;
      this.cauhinhdienthoai = dienthoai;
      this.mota = mota;
    ...
    updateSanpham(sanpham) {
      axios
        .put("sanphamdienthoai/" + sanpham.id, {
          id: sanpham.id,
          ...
          manhinh: this.sanpham.cauhinhdienthoai.manhinh,
          hdh: this.sanpham.cauhinhdienthoai.hdh,
          cpu: this.sanpham.cauhinhdienthoai.cpu,
          ram: this.sanpham.cauhinhdienthoai.ram,
          camera: this.sanpham.cauhinhdienthoai.camera,
          bonho: this.sanpham.cauhinhdienthoai.bonho,
          pin: this.sanpham.cauhinhdienthoai.pin,
          thongtinkhac: this.sanpham.cauhinhdienthoai.thongtinkhac
        })
        .then(reponse => {
          swal({
            position: "mid",
    ...
    deleteSanpham(sanpham, index) {
      swal({
        ...
        if (result.value) {
          axios
            .delete("sanphamdienthoai/" + sanpham.id)
            .then(response => {

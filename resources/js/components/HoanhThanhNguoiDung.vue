<template>
  <div>
    <div class="table-responsive">
      <table class="table" id="table-hoanthanh">
        <thead>
          <tr>
            <th>Mã đơn hàng</th>
        ...
        <tbody>
          <tr v-for="(item,index) in hoanthanh" :key="index">
            <td>{{item.id}}</td>
            ...
            <td>
              <button
                class="btn-info"
                type="button"
                @click="openModalHoanThanh(item.chitietdonhang)"
              >
    ...
    <div class="modal fade" id="modal-chitiethoanthanh">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="table-responsive">
              <table class="table" id="modal-hoanthanh">
                <thead>
                  <tr>
                    <th>Mã</th>
                    <th>Mã đơn hàng</th>
...
$(document).ready(function() {
  $("#table-hoanthanh").DataTable();
});
export default {
  props: ["hoanthanh", "sanpham"],
  data() {
    return {
      danhsachchitiet: []
    };
  ...
  created() {},
  methods: {
    openModalHoanThanh(item) {
      $("#modal-chitiethoanthanh").modal("show");

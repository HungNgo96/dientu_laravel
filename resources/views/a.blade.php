...
<head>
  ...
  <link rel="icon" href="@yield('icon')" type="image/gif" sizes="16x16">
...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item has-treeview">
                  ...
                  <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                      <a href="{{route('admin.sanpham.laptop')}}" class="nav-link">
                              <i class="nav-icon fa fa-circle"></i>
    ...
    <div class="content-wrapper">
      ...
      <!-- /.content-header -->
      {{--
      <Maincontent> --}} @yield('content') {{-- </Maincontent> --}}
    </div>
    <!-- /.content-wrapper -->
  ...
  {{--
  <script src="{{asset('public/admin/js/dataTables.responsive.min.js')}}"></script> --}} {{-- --appjs --}} {{--
  <script src="{{asset('public/js/app.js')}}"></script> --}}
